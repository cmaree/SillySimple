...
$("#IAUqa").click(function(){ genericClick('https://release.lmbinsurance.com/auto/?force=');});	
$("#IAUdev").click(function(){genericClick('https://dev.lmbinsurance.com/auto/?force=');});	

/* LIFE apps */
$("#LIFEprod").click(function(){genericClick('https://www.lmbinsurance.com/life/?force=');});			
$("#LIFEqa").click(function(){genericClick('https://release.lmbinsurance.com/life/?force=');});	
$("#LIFEdev").click(function(){genericClick('https://dev.lmbinsurance.com/life/?force=');});

/* EDU apps */
$("#EDUprod").click(function(){	genericClick('https://www.classesusa.com/schools/?force=');});	
$("#EDUqa").click(function(){ genericClick('http://release.classesusa.com/schools/?force=');});	
$("#EDUdev").click(function(){genericClick('http://esv-edudev-http01.lowermybills.com/schools/?force=');});	

/* LENDING apps */
$("#LENDprod").click(function(){genericClick('https://www.lowermybills.com/lending/home-refinance?force=');});			
$("#LENDqa").click(function(){genericClick('http://release.lowermybills.com/lending/home-refinance?force=');});	
